  ...
  return (
    ...
    <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        <div className="flex items-center justify-center">
            <button data-tooltip-target="tooltip-new" type="button" className={`inline-flex items-center justify-center ${isDarkMode?'bg-white':''} w-10 h-10 font-medium bg-custom-blue rounded-full hover:bg-blue-700 group `}>
        ...
        <Link to="/settings" data-tooltip-target="tooltip-profile" type="button" className="inline-flex flex-col items-center justify-center px-5 rounded-e-full hover:bg-gray-50  group">
