...
function PremiumAd() {
  ...
  return (
    <div className={`h-auto  overflow-hidden rounded-lg ${isDarkMode?'bg-blue-950/75':'bg-white'} w-full mt-14 p-10 flex flex-col shadow-xl border `}>
      ...
      <button className={` ${isDarkMode?'bg-custom-gold  text-black':' bg-custom-gold hover:bg-yellow-400'} mt-4 lg:text-f-10 text-center w-auto  font-bold py-2 px-4 rounded-full xl:text-sm`}>
  Upgrade
</button>
    </div>
  )
