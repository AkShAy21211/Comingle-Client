...
function Header() {
  ...
  return (
  <nav className="bg-custom-blue fixed w-full z-50">
    ...
    <div className="relative flex h-16 items-center justify-between">
      ...
      <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div className="relative  ml-3">
          <div>
            <button onClick={handleProfileToogle} type="button" className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
              <span className="absolute -inset-1.5"></span>
 ...
 
         {
          profileMenue && (
            ...
            <Link to="#" className="block  focus:bg-custom-blue focus:text-white  active:bg-custom-blue active:text-white px-4 py-2 text-sm text-gray-700" role="menuitem"  id="user-menu-item-0">Your Profile</Link>
            <Link to="#" className="block  focus:bg-custom-blue focus:text-white   active:bg-custom-blue active:text-white px-4 py-2 text-sm text-gray-700" role="menuitem"id="user-menu-item-1">Settings</Link>
            <Link to="#" className="block  focus:bg-custom-blue focus:text-white   active:bg-custom-blue active:text-white px-4 py-2 text-sm text-gray-700" role="menuitem"  id="user-menu-item-2">Sign out</Link>
          </div>
          )
         }
        </div>
