    ...
    <div className=" h-full  col-span-full lg:col-span-3  ">
      <div className="   flex  md:flex   mt-20 px-5" id="top-search-bar">
        ...
        <div className={`w-96 h-8  justify-end hidden md:flex gap-5`}>
          <button onClick={handleShowPosts} className="bg-custom-teal p-4 rounded-lg text-white text-center flex justify-center items-center">
            Posts
          </button>
          <button  onClick={handleShowPeople} className="bg-custom-teal p-4 rounded-lg text-white text-center flex justify-center items-center">
            People
          </button>
        </div>
        <div
